...
| 风险 | 影响 | 当前处置 |
| --- | --- | --- |
| GUI i18n 历史硬编码仍较多 | P3 `i18n 文案抽离完整化` 尚不能验收 | 已加入 `scripts/check_gui_i18n_hardcoded.py` 基线守卫，禁止新增净硬编码；后续按页面/对话框逐批降低基线 |
...
| GUI i18n 基线守卫 | 回退 `scripts/check_gui_i18n_hardcoded.py` 与对应测试 |
