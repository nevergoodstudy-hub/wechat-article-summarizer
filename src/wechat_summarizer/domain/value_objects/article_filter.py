...
class ArticleFilter:
    ...
    def __post_init__(self) -> None:
        ...
        if self.min_count > 0 and self.max_count > 0 and self.min_count > self.max_count:
    ...
    def matches(self, item: ArticleListItem) -> bool:
        ...
        if self.keyword:
            ...
            if keyword_lower not in item.title.lower() and keyword_lower not in item.digest.lower():
                return False
        ...
        # 原创筛选
        return not (self.original_only and not item.is_original)
