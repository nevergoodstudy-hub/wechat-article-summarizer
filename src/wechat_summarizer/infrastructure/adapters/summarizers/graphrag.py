...
class GraphRAGSummarizer:
    ...
    def summarize(
        ...
        try:
            ...
            # 降级到基础摘要器
            fallback_max_length = max_length if max_length is not None else 500
            return self._base_summarizer.summarize(content, style, fallback_max_length)
    ...
    def _build_knowledge_graph(self, text: str) -> KnowledgeGraph:
        ...
        logger.info(f"知识图谱构建完成: {kg.entity_count} 实体, {kg.relationship_count} 关系")
