...
class KeyboardShortcutManager:
    ...
    def __init__(self, root: tk.Tk):
        ...
        self._config_file = os.path.join(
            os.path.expanduser("~"), ".wechat_summarizer", "shortcuts.json"
        )
    ...
    def _register_defaults(self):
        ...
        defaults = [
            Shortcut(
                id="save", name="保存", keys="Ctrl+S", group="文件", description="保存当前文件"
            ),
            ...
            Shortcut(
                id="undo", name="撤销", keys="Ctrl+Z", group="编辑", description="撤销上一步操作"
            ),
            Shortcut(
                id="redo", name="重做", keys="Ctrl+Y", group="编辑", description="重做上一步操作"
            ),
            Shortcut(
                id="copy", name="复制", keys="Ctrl+C", group="编辑", description="复制选中内容"
            ),
            Shortcut(
                id="paste", name="粘贴", keys="Ctrl+V", group="编辑", description="粘贴剪贴板内容"
            ),
            Shortcut(
                id="cut", name="剪切", keys="Ctrl+X", group="编辑", description="剪切选中内容"
            ),
            Shortcut(
                id="select_all",
                name="全选",
            ...
            Shortcut(
                id="find", name="查找", keys="Ctrl+F", group="编辑", description="打开查找对话框"
            ),
            Shortcut(
                id="zoom_in", name="放大", keys="Ctrl+=", group="视图", description="放大界面"
            ),
            Shortcut(
                id="zoom_out", name="缩小", keys="Ctrl+-", group="视图", description="缩小界面"
            ),
            Shortcut(
                id="zoom_reset",
                name="重置缩放",
    ...
    def enable(self, shortcut_id: str | None = None):
        """启用快捷键"""
        if shortcut_id:
    ...
    def disable(self, shortcut_id: str | None = None):
        """禁用快捷键"""
        if shortcut_id:
            if shortcut_id in self._shortcuts:
    ...
    def _save_custom_bindings(self):
        ...
        try:
            ...
            custom = {s.id: s.keys for s in self._shortcuts.values()}
