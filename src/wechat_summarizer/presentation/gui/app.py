...
from .styles.colors import (
    ModernColors as NewModernColors,
    THEME_DARK,
    THEME_LIGHT,
    get_theme,
    to_tkinter_color
...
class ModernColors:
    """现代化颜色配置 - 2026 UI 设计趋势
    
    采用液态玻璃效果 + 渐变色彩 + OLED友好色彩方案
    
    已集成新色彩系统 (styles/colors.py)，所有颜色均为Tkinter兼容格式
    """
    # ========== 深色主题 (OLED友好) ==========
    DARK_BG = NewModernColors.DARK_BG
    DARK_BG_SECONDARY = NewModernColors.DARK_BG_SECONDARY
    DARK_BG_TERTIARY = NewModernColors.DARK_BG_TERTIARY
    DARK_SIDEBAR = NewModernColors.DARK_SIDEBAR
    DARK_CARD = NewModernColors.DARK_CARD
    DARK_CARD_HOVER = NewModernColors.DARK_CARD_HOVER
    DARK_ELEVATED = NewModernColors.DARK_ELEVATED
    DARK_ACCENT = NewModernColors.DARK_ACCENT
    DARK_ACCENT_HOVER = NewModernColors.DARK_ACCENT_HOVER
    DARK_ACCENT_PRESSED = NewModernColors.DARK_ACCENT_PRESSED
    DARK_TEXT = NewModernColors.DARK_TEXT
    DARK_TEXT_SECONDARY = NewModernColors.DARK_TEXT_SECONDARY
    DARK_TEXT_MUTED = NewModernColors.DARK_TEXT_MUTED
    DARK_TEXT_DISABLED = NewModernColors.DARK_TEXT_DISABLED
    DARK_BORDER = NewModernColors.DARK_BORDER
    DARK_BORDER_SUBTLE = NewModernColors.DARK_BORDER_SUBTLE
    DARK_DIVIDER = NewModernColors.DARK_DIVIDER
    # 液态玻璃效果 (Tkinter兼容版本)
    DARK_GLASS = NewModernColors.DARK_GLASS_SOLID
    DARK_GLASS_BORDER = NewModernColors.DARK_GLASS_BORDER_SOLID
    
    # ========== 浅色主题 ==========
    LIGHT_BG = NewModernColors.LIGHT_BG
    LIGHT_BG_SECONDARY = NewModernColors.LIGHT_BG_SECONDARY
    LIGHT_BG_TERTIARY = NewModernColors.LIGHT_BG_TERTIARY
    LIGHT_SIDEBAR = NewModernColors.LIGHT_SIDEBAR
    LIGHT_CARD = NewModernColors.LIGHT_CARD
    LIGHT_CARD_HOVER = NewModernColors.LIGHT_CARD_HOVER
    LIGHT_ELEVATED = NewModernColors.LIGHT_ELEVATED
    LIGHT_ACCENT = NewModernColors.LIGHT_ACCENT
    LIGHT_ACCENT_HOVER = NewModernColors.LIGHT_ACCENT_HOVER
    LIGHT_ACCENT_PRESSED = NewModernColors.LIGHT_ACCENT_PRESSED
    LIGHT_TEXT = NewModernColors.LIGHT_TEXT
    LIGHT_TEXT_SECONDARY = NewModernColors.LIGHT_TEXT_SECONDARY
    LIGHT_TEXT_MUTED = NewModernColors.LIGHT_TEXT_MUTED
    LIGHT_TEXT_DISABLED = NewModernColors.LIGHT_TEXT_DISABLED
    LIGHT_BORDER = NewModernColors.LIGHT_BORDER
    LIGHT_BORDER_SUBTLE = NewModernColors.LIGHT_BORDER_SUBTLE
    LIGHT_DIVIDER = NewModernColors.LIGHT_DIVIDER
    # 液态玻璃效果 (Tkinter兼容版本)
    LIGHT_GLASS = NewModernColors.LIGHT_GLASS_SOLID
    LIGHT_GLASS_BORDER = NewModernColors.LIGHT_GLASS_BORDER_SOLID
    
    # ========== 语义化颜色 ==========
    SUCCESS = NewModernColors.SUCCESS
    SUCCESS_LIGHT = NewModernColors.SUCCESS_LIGHT
    SUCCESS_BG = NewModernColors.SUCCESS_BG
    WARNING = NewModernColors.WARNING
    WARNING_LIGHT = NewModernColors.WARNING_LIGHT
    WARNING_BG = NewModernColors.WARNING_BG
    ERROR = NewModernColors.ERROR
    ERROR_LIGHT = NewModernColors.ERROR_LIGHT
    ERROR_BG = NewModernColors.ERROR_BG
    INFO = NewModernColors.INFO
    INFO_LIGHT = NewModernColors.INFO_LIGHT
    INFO_BG = NewModernColors.INFO_BG
    ...
    NEON_PINK = '#ec4899'
    NEON_GREEN = '#22c55e'
    SHIMMER_LIGHT = '#ffffff1a'  # 原 rgba(255, 255, 255, 0.1) -> 十六进制
    GLOW_PURPLE = '#8b5cf64d'   # 原 rgba(139, 92, 246, 0.3)
    GLOW_BLUE = '#6366f14d'     # 原 rgba(99, 102, 241, 0.3)
    
    # ========== 阴影 (CSS格式，Tkinter不直接支持) ==========
    ...
    # ========== 10级灰度色阶 (WCAG兼容) ==========
    DARK_GRAY_50 = NewModernColors.DARK_GRAY_50
    DARK_GRAY_100 = NewModernColors.DARK_GRAY_100
    DARK_GRAY_200 = NewModernColors.DARK_GRAY_200
    DARK_GRAY_300 = NewModernColors.DARK_GRAY_300
    DARK_GRAY_400 = NewModernColors.DARK_GRAY_400
    DARK_GRAY_500 = NewModernColors.DARK_GRAY_500
    DARK_GRAY_600 = NewModernColors.DARK_GRAY_600
    DARK_GRAY_700 = NewModernColors.DARK_GRAY_700
    DARK_GRAY_800 = NewModernColors.DARK_GRAY_800
    DARK_GRAY_900 = NewModernColors.DARK_GRAY_900
class Spacing:
...
class Windows11StyleHelper:
    ...
    @staticmethod
    def apply_window_style(root, appearance_mode: str = 'dark'):
        """应用 Windows 11 窗口样式
        ...
        """
        if not Windows11StyleHelper.is_windows_11():
        ...
        try:
            ...
            if appearance_mode == 'dark':
                pywinstyles.change_header_color(root, ModernColors.DARK_BG)
                pywinstyles.change_border_color(root, ModernColors.DARK_BORDER)
            else:
                pywinstyles.change_header_color(root, ModernColors.LIGHT_BG)
                pywinstyles.change_border_color(root, ModernColors.LIGHT_BORDER)
            
            # 应用 Mica 材质效果 (可选)
            # pywinstyles.apply_style(root, 'mica')  # 注释: Mica 可能与 CustomTkinter 冲突
    ...
    @staticmethod
    def update_titlebar_color(root, appearance_mode: str):
        """更新标题栏颜色
...
class ChineseFonts:
    """中文字体配置 - 支持Windows系统"""
    CHINESE_FONT_FAMILIES = ['Microsoft YaHei UI', 'Microsoft YaHei', 'SimHei', 'SimSun', 'NSimSun', 'KaiTi', 'FangSong', 'Arial']
    SIZE_TITLE = 24
    SIZE_HEADING = 18
    SIZE_SUBHEADING = 16
    SIZE_NORMAL = 14
