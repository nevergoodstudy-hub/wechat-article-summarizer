...
a = Analysis(
    ['D:\\Newidea-warp\\src\\launcher.py'],
    pathex=[],
    binaries=[],
    datas=[],
    hiddenimports=[],
...
src = 'D:\\Newidea-warp\\src'
resfile = 'D:\\Newidea-warp\\src\\.pyarmor\\pack\\resources.list'
hookscript = 'D:\\Newidea-warp\\src\\.pyarmor\\pack\\hook-pyarmor_runtime_000000.py'
